package io.github.iwag.todomvp.dummy;
...
public class TodoContent {
    ...
    private static TodoItem createDummyItem(int position) {
        return new TodoItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    public static class TodoItem {
        ...
        public TodoItem(String id, String content, String details) {
            this.id = id;
